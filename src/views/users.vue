...
<!--              <el-input v-model="searchForm.lastLoginTime" placeholder="最后登录"></el-input>-->
<!--            </el-form-item>-->
...
<!--              <el-input v-model="searchForm.createdAt" placeholder="创建时间"></el-input>-->
<!--            </el-form-item>-->
<!--            <el-form-item label="头像" prop="avatar">-->
<!--              <el-input v-model="searchForm.avatar" placeholder="头像"></el-input>-->
<!--            </el-form-item>-->
<!--            <el-form-item label="更新时间" prop="updatetime">-->
<!--              <el-input v-model="searchForm.updatetime" placeholder="更新时间"></el-input>-->
<!--            </el-form-item>-->
...
<!--        </el-form-item>-->
<!--        <el-form-item label="最后登录" prop="lastLoginTime">-->
<!--          <el-date-picker type="date" v-model="form.lastLoginTime" placeholder="选择时间"></el-date-picker>-->
<!--        </el-form-item>-->
<!--        <el-form-item label="用户ID" prop="userId">-->
...
<!--        <el-form-item label="创建时间" prop="createdAt">-->
<!--          <el-date-picker type="date" v-model="form.createdAt" placeholder="选择时间"></el-date-picker>-->
<!--        </el-form-item>-->
        <el-form-item label="头像" prop="avatar">
...
<!--        <el-form-item label="更新时间" prop="updatetime">-->
<!--          <el-date-picker type="date" v-model="form.updatetime" placeholder="选择时间"></el-date-picker>-->
<!--        </el-form-item>-->
        <el-form-item label="邮箱" prop="email">
...
this.resetForm();
    ...
    deleteRow(row) {
      ...
      axios
        .delete(`http://localhost:9655/${this.tableName.replace("tb_", "")}/${row.userId}`)
        .then((response) => {
